...
JTC.dialog = function(){
    ...
    load.setAttribute('style','width:200px;height:160px;font-size:12px;background-color:#ffffff; position:absolute;border-collapse:collapse;');
    load.style.cssText = 'width:200px;height:160px;font-size:12px;background-color:#ffffff; position:absolute;border-collapse:collapse;'; 
    load.border = 1;
...
JTC.events = {
    ...
    beginToSelectYear : function()
    {
        ...
        var html = '<select id="' + JTC.config.yearSelectCtrl + '" Author="fresh" style="font-size:12px;width:80px;"';
        html += '>';
    ...
    beginToSelectMonth : function()
    {
        ...
        var html = '<select id="' + JTC.config.monthSelectCtrl + '" Author="fresh" style="font-size:12px;width:60px;" ';
        html += '>';
        for(var i=1; i<=12; i++)
        {
            if(i == month){
